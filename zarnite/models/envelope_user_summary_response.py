...
class EnvelopeUserSummaryResponse(BaseModel):
    """
    EnvelopeUserSummaryResponse
    """ # noqa: E501
    data: UserSummaryResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": UserSummaryResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
