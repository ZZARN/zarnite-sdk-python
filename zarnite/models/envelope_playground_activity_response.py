...
class EnvelopePlaygroundActivityResponse(BaseModel):
    """
    EnvelopePlaygroundActivityResponse
    """ # noqa: E501
    data: PlaygroundActivityResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PlaygroundActivityResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
