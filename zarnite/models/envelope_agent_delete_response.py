...
class EnvelopeAgentDeleteResponse(BaseModel):
    """
    EnvelopeAgentDeleteResponse
    """ # noqa: E501
    data: AgentDeleteResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AgentDeleteResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
