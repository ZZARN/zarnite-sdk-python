...
class AgentDeleteResponse(BaseModel):
    ...
    AgentDeleteResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Deleted agent identifier")
    org_id: StrictStr = Field(description="Organization that owned the deleted agent", alias="orgId")
    deleted: Optional[StrictBool] = Field(default=True, description="Deletion result")
    __properties: ClassVar[List[str]] = ["id", "orgId", "deleted"]
