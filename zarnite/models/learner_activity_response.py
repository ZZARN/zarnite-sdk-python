...
class LearnerActivityResponse(BaseModel):
    """
    LearnerActivityResponse
    """ # noqa: E501
    learner_id: StrictStr = Field(description="Learner identifier", alias="learnerId")
    events: Optional[List[LearnerActivityEvent]] = Field(default=None, description="Recent session activity events")
    __properties: ClassVar[List[str]] = ["learnerId", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [LearnerActivityEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
