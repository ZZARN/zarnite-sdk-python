...
class VoiceRuntimeSessionRef(BaseModel):
    """
    ...
    room_name: Optional[StrictStr] = Field(default=None, description="LiveKit room name for the session", alias="roomName")
    __properties: ClassVar[List[str]] = ["sessionId", "threadId", "roomName"]
