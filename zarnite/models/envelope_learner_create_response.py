...
class EnvelopeLearnerCreateResponse(BaseModel):
    """
    EnvelopeLearnerCreateResponse
    """ # noqa: E501
    data: LearnerCreateResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": LearnerCreateResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
