...
class BodyUploadPreviewDocumentsV1PlaygroundPreviewDocumentsPost(BaseModel):
    """
    BodyUploadPreviewDocumentsV1PlaygroundPreviewDocumentsPost
    """ # noqa: E501
    org_id: StrictStr
    preview_agent_id: StrictStr
    files: List[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]]
    user_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["org_id", "preview_agent_id", "files", "user_id"]
