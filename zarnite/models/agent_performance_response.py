...
class AgentPerformanceResponse(BaseModel):
    ...
    messages: Dict[str, Any] = Field(description="Message volume")
    errors: StrictInt = Field(description="Total error events")
    error_rate: Union[StrictFloat, StrictInt] = Field(description="Error rate (errors / sessions)", alias="errorRate")
    __properties: ClassVar[List[str]] = ["orgId", "agentId", "sessions", "messages", "errors", "errorRate"]
