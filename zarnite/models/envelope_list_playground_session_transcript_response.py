...
class EnvelopeListPlaygroundSessionTranscriptResponse(BaseModel):
    """
    EnvelopeListPlaygroundSessionTranscriptResponse
    """ # noqa: E501
    data: List[PlaygroundSessionTranscriptResponse] = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PlaygroundSessionTranscriptResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
