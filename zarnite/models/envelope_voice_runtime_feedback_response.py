...
class EnvelopeVoiceRuntimeFeedbackResponse(BaseModel):
    """
    EnvelopeVoiceRuntimeFeedbackResponse
    """ # noqa: E501
    data: VoiceRuntimeFeedbackResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": VoiceRuntimeFeedbackResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
