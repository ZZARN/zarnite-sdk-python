...
class EnvelopeMemorySearchResponse(BaseModel):
    """
    EnvelopeMemorySearchResponse
    """ # noqa: E501
    data: MemorySearchResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": MemorySearchResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
