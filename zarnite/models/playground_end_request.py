...
class PlaygroundEndRequest(BaseModel):
    """
    PlaygroundEndRequest
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default='user_left', description="Reason for ending the session")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reason": obj.get("reason") if obj.get("reason") is not None else 'user_left'
        })
        return _obj
