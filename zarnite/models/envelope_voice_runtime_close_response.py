...
class EnvelopeVoiceRuntimeCloseResponse(BaseModel):
    """
    EnvelopeVoiceRuntimeCloseResponse
    """ # noqa: E501
    data: VoiceRuntimeCloseResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": VoiceRuntimeCloseResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
