...
class DeploymentShareVerifyResponse(BaseModel):
    """
    DeploymentShareVerifyResponse
    """ # noqa: E501
    authorized: Optional[StrictBool] = Field(default=True, description="Whether learner is authorized")
    learner: Dict[str, Any] = Field(description="Verified learner context")
    deployment: Dict[str, Any] = Field(description="Resolved deployment context")
    __properties: ClassVar[List[str]] = ["authorized", "learner", "deployment"]
