...
class OrgCreditWalletUpdateRequest(BaseModel):
    """
    OrgCreditWalletUpdateRequest
    """ # noqa: E501
    grant_credits: Annotated[int, Field(strict=True, ge=0)] = Field(description="Monthly included credits for the active month")
    __properties: ClassVar[List[str]] = ["grant_credits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "grant_credits": obj.get("grant_credits")
        })
        return _obj
