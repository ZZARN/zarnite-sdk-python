...
class VoiceRuntimeTranscriptPayload(BaseModel):
    """
    VoiceRuntimeTranscriptPayload
    """ # noqa: E501
    messages: Optional[List[VoiceRuntimeTranscriptMessage]] = Field(default=None, description="Ordered transcript messages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [VoiceRuntimeTranscriptMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
