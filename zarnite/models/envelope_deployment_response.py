...
class EnvelopeDeploymentResponse(BaseModel):
    """
    EnvelopeDeploymentResponse
    """ # noqa: E501
    data: DeploymentResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DeploymentResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
