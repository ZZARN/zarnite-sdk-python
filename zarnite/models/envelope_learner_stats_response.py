...
class EnvelopeLearnerStatsResponse(BaseModel):
    """
    EnvelopeLearnerStatsResponse
    """ # noqa: E501
    data: LearnerStatsResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": LearnerStatsResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
