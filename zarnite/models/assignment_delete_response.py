...
class AssignmentDeleteResponse(BaseModel):
    ...
    """ # noqa: E501
    learner_id: StrictStr = Field(description="Unassigned learner", alias="learnerId")
    agent_id: StrictStr = Field(description="Agent removed from", alias="agentId")
    deleted: Optional[StrictBool] = Field(default=True, description="Deletion result")
    __properties: ClassVar[List[str]] = ["learnerId", "agentId", "deleted"]
