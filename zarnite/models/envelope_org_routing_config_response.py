...
class EnvelopeOrgRoutingConfigResponse(BaseModel):
    """
    EnvelopeOrgRoutingConfigResponse
    """ # noqa: E501
    data: OrgRoutingConfigResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": OrgRoutingConfigResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
