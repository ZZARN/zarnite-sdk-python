...
class PlaygroundEndResponse(BaseModel):
    """
    PlaygroundEndResponse
    """ # noqa: E501
    session_id: StrictStr = Field(description="Ended session identifier", alias="sessionId")
    status: StrictStr = Field(description="New session status")
