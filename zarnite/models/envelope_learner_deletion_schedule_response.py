...
class EnvelopeLearnerDeletionScheduleResponse(BaseModel):
    """
    EnvelopeLearnerDeletionScheduleResponse
    """ # noqa: E501
    data: LearnerDeletionScheduleResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": LearnerDeletionScheduleResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
