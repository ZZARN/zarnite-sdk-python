...
class EnvelopeApiKeyStatsResponse(BaseModel):
    """
    EnvelopeApiKeyStatsResponse
    """ # noqa: E501
    data: ApiKeyStatsResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiKeyStatsResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
