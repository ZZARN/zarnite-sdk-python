...
class EnvelopeListUsageLogEntry(BaseModel):
    """
    EnvelopeListUsageLogEntry
    """ # noqa: E501
    data: List[UsageLogEntry] = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [UsageLogEntry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
