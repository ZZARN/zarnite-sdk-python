...
class EnvelopeBehaviorResponse(BaseModel):
    """
    EnvelopeBehaviorResponse
    """ # noqa: E501
    data: BehaviorResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BehaviorResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
