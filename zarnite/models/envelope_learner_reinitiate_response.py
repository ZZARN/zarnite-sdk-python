...
class EnvelopeLearnerReinitiateResponse(BaseModel):
    """
    EnvelopeLearnerReinitiateResponse
    """ # noqa: E501
    data: LearnerReinitiateResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": LearnerReinitiateResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
