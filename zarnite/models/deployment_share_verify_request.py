...
class DeploymentShareVerifyRequest(BaseModel):
    """
    DeploymentShareVerifyRequest
    """ # noqa: E501
    learner_id: StrictStr = Field(description="Learner identifier supplied by the user (public learnerId or internal id)")
    access_key: StrictStr = Field(description="Learner access key")
    recaptcha_token: Optional[StrictStr] = Field(default=None, description="Optional reCAPTCHA token")
    __properties: ClassVar[List[str]] = ["learner_id", "access_key", "recaptcha_token"]
