...
class EnvelopeLearnerVerifyResponse(BaseModel):
    """
    EnvelopeLearnerVerifyResponse
    """ # noqa: E501
    data: LearnerVerifyResponse = Field(description="Response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": LearnerVerifyResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
